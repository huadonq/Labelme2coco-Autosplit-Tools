...
def merge_coco_json(file_path,save_path):
    file_count = 0
...
file_path = '/home/jovyan/qrcode-single-detection/clean_data/train/annotations/'  # 待合并的路径
if __name__ == "__main__":
    merge_coco_json(file_path, '/home/jovyan/qrcode-single-detection/tmp.json')